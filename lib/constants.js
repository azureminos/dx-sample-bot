const get = () => {
  return {
    Global: {
      ...
      ADDR_TYPE_STADDR: 'street_address',
      ADDR_TYPE_ESTBSH: 'establishment',
      ADDR_TYPE_LOCALT: 'locality',
      defaultImgUrl:
        'https://www.eainsurance.com.au/wp-content/uploads/2020/05/Travel1.jpg',
    },
    Style: {
      Color: {
        primary: 'rgb(0,74,163)',
        secondary: 'rgb(232,242,254)',
        default: 'rgb(45,132,237)',
      },
      defaultFont: 'arial',
    },
    Country: [
